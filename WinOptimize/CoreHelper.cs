...
namespace WinOptimize
{
    ...
    {
        internal readonly static string CoreFolder = CleanHelper.ProgramData + "\\WinOptimize\\";
        internal readonly static string ReadyMadeMenusFolder = CleanHelper.ProgramData + "\\WinOptimize\\ReadyMadeMenus\\";
        internal readonly static string ScriptsFolder = CleanHelper.ProgramData + "\\WinOptimize\\Required\\";
        internal readonly static string ExtractedIconsFolder = CleanHelper.ProgramData + "\\WinOptimize\\ExtractedIcons\\";
        internal readonly static string FavIconsFolder = CleanHelper.ProgramData + "\\WinOptimize\\FavIcons\\";
        internal readonly static string StartupItemsBackupFolder = CleanHelper.ProgramData + "\\WinOptimize\\StartupBackup\\";

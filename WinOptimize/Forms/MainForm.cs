...
namespace WinOptimize
{
    public sealed partial class MainForm : Form
    {
        ...
        readonly string _feedLink = "https://raw.githubusercontent.com/Emre37destan/WinOptimize/master/feed.json";
        readonly string _feedImages = "https://raw.githubusercontent.com/Emre37destan/WinOptimize/master/images/feed.zip";
        ...
        readonly string _githubProjectLink = "https://github.com/Emre37destan/WinOptimize";
        readonly string _paypalSupportLink = "https://www.paypal.com/paypalme/supportoptimizer";

        readonly string _latestVersionLink = "https://raw.githubusercontent.com/Emre37destan/WinOptimize/master/version.txt";
        readonly string _changelogRawLink = "https://raw.githubusercontent.com/Emre37destan/WinOptimize/master/CHANGELOG.md";
        readonly string _faqSectionLink = "https://github.com/Emre37destan/WinOptimize/blob/master/FAQ.md";

        readonly string _bugReportLink = "https://github.com/Emre37destan/WinOptimize/issues/new?assignees=&labels=&projects=&template=bug_report.md&title=";
        readonly string _featureRequestLink = "https://github.com/Emre37destan/WinOptimize/issues/new?assignees=&labels=&projects=&template=feature_request.md&title=";
        ...
        {
            return string.Format("https://github.com/Emre37destan/WinOptimize/releases/download/{0}/WinOptimize-{0}.exe", latestVersion);
        }
        ...
        private void CheckForUpdate(bool silentCheck = false)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message, "WinOptimize", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
                ...
                if (latestVersionFloat > Program.GetCurrentVersionToFloat())
                {
                    ...
                    if (_updateForm.ShowDialog() == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            string archiveFile = Path.Combine(appFolder, "WinOptimize_old" + appExtension);
                            string appFile = Path.Combine(appFolder, appName + appExtension);
                            string tempFile = Path.Combine(appFolder, "WinOptimize_tmp" + appExtension);
        ...
        public MainForm(SplashForm _splashForm, bool? disableIndicium = null, bool? disableHostsEditor = null, bool? disableCommonApps = null, bool? disableUWPApps = null, bool? disableStartups = null, bool? disableCleaner = null, bool? disableIntegrator = null, bool? disablePinger = null)
        {
            ...
            //telemetrySvcToggle.ToggleChecked = Options.CurrentOptions.DisableWinOptimizeTelemetry;
        ...
        private async void UninstallModernApps()
        {
            ...
            if (MessageBox.Show(_removeModernAppsMessage, "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                uninstallModernAppsButton.Enabled = false;
                refreshModernAppsButton.Enabled = false;
                ...
                {
                    MessageBox.Show(_errorModernAppsMessage + failedApps, "WinOptimize", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        private void button32_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(_removeStartupItemsMessage + Environment.NewLine + Environment.NewLine + report, "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        {
            if (MessageBox.Show(_repairMessage, "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                Utilities.Repair();
            }
        }
        ...
        private void toggleSwitch4_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(OptionsHelper.TranslationList["systemRestoreM"].ToString(), "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                {
        ...
        private void toggleSwitch14_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show(OptionsHelper.TranslationList["onedriveM"].ToString(), "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                {
                    _skipOneDrive = true;
        ...
        private async void btnDownloadApps_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(OptionsHelper.TranslationList["downloadDirInvalid"].ToString(), "WinOptimize", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void btnViewLog_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(OptionsHelper.TranslationList["noErrorsM"].ToString(), "WinOptimize", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        {
            if (MessageBox.Show(_flushDNSMessage, "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        private void btnSaveHW_Click(object sender, EventArgs e)
        {
            ...
            d.FileName = $"WinOptimize_Hardware_{Environment.MachineName}_{DateTime.Now.ToString("dd-MM-yyyy")}.txt";
        ...
        private string ParseChangelog()
        {
            ...
            {
                MessageBox.Show(_noNewVersionMessage, "WinOptimize", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return string.Empty;
            }
        ...
        {
            if (MessageBox.Show(_uwpRestoreMessage, "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        {
            Microsoft.Win32.Registry.SetValue(@"HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\RunOnce", "*WinOptimizeDisableDefender", Assembly.GetExecutingAssembly().Location + " /silentdisabledefender", Microsoft.Win32.RegistryValueKind.String);
            Program.RestartInSafeMode();
        }
        ...
        {
            if (MessageBox.Show(_reinforcePoliciesMessage, "WinOptimize", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
